...
| **Substack** | `…/substack/` | Posts hub for the SCE Substack: card grid of companion prototypes built alongside posts, each hosted at `…/substack/<post-slug>/`, plus a subscribe CTA. First entry: the NYC Grocery Access supermarket site-selection prototype. |
